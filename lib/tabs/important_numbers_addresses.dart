...
class ImportantNumbersAddressesTab extends StatelessWidget {
  const ImportantNumbersAddressesTab({super.key});

  Future<void> _copyToClipboard(String phoneNumber, BuildContext context) async {
    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('حدث خطأ أثناء محاولة نسخ الرقم. يرجى المحاولة مرة أخرى'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        title: const Text('0567099821'),
                        onTap: () => _copyToClipboard('0567099821', context),
                      ),
                      ListTile(
                        leading: const Icon(Icons.content_copy, color: Colors.green),
                        title: const Text('0569601161'),
                        onTap: () => _copyToClipboard('0569601161', context),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildHospitalTile(
                        ...
                        ['غسيل كلوي', 'مخ وأعصاب', 'عظام', 'جراحة'],
                      ),
                      _buildHospitalTile(
                        'مستشفى حراء العام',
                        ['رعاية مركزة', 'باطنة', 'جراحة', 'رمد', 'أطفال', 'نساء وولادة'],
                      ),
                      _buildHospitalTile(
